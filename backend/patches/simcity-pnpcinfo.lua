...
function SimCityNPCInfo:getHPByCap(capHP)
	if capHP == 1 then
		return random(SIMBOT_HP_CAP1_MIN or 10000, SIMBOT_HP_CAP1_MAX or 20000)
	end
	if capHP == 2 then
		return random(SIMBOT_HP_CAP2_MIN or 30000, SIMBOT_HP_CAP2_MAX or 40000)
	end

	return random(SIMBOT_HP_CAP3_MIN or 50000, SIMBOT_HP_CAP3_MAX or 80000)
end
